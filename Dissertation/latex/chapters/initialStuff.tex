...
\footnotetext[1]{Computed by summing,\texttt{texcount -1 -utf8 -sum -inc diss.tex} using flags to include words in tables, over the five main chapters.}
\footnotetext[2]{File line count for all Typescript and Python files and the JSON file for customFunctions definitions. No typescript or node configuration files, css, or markup included.}
