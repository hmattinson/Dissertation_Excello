...
\paragraph{} Whilst there was no significant evidence to suggest Excello outperformed Sibelius across these CDN, that it achieved similar results to Sibelius, an established music notation editing package, suggests that despite being built for a genereal purpose spreadsheet environment, Excello is successful interface for writing music.
